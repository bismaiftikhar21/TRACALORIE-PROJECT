...
// lower block(add meal, add workout) and attach all and (collapse toggle)
/////////////////////////////////////////////////////////////////
...
class App {
  ...
  _newItem(type, e) {
    ...
    const collapseItems = document.getElementById(`collapse-${type}`);
    const bsCollapse = new bootstrap.Collapse(collapseItems, {
      toggle: true
    });
  } 
